...
extern void gen_hash(const unsigned char *data, unsigned int len,
                     unsigned char *hash);
...
typedef struct _algorithm_t {
  ...
  void (*set_compile_options)(struct _build_kernel_data *, struct cgpu_info *,
                              struct _algorithm_t *);
} algorithm_t;
...
typedef struct _algorithm_settings_t {
  ...
  cl_int (*queue_kernel)(struct __clState *, struct _dev_blk_ctx *, cl_uint);
  void (*gen_hash)(const unsigned char *, unsigned int, unsigned char *);
  void (*set_compile_options)(build_kernel_data *, struct cgpu_info *,
                              algorithm_t *);
