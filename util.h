...
static inline bool sock_timeout(void) { return (errno == ETIMEDOUT); }
static inline bool interrupted(void) { return (errno == EINTR); }
#elif defined WIN32
#include <winsock2.h>
#include <ws2tcpip.h>
...
#define cgsem_mswait(_sem, _timeout)                                           \
  _cgsem_mswait(_sem, _timeout, __FILE__, __func__, __LINE__)
